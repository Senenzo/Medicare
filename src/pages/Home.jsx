...
const Home = () => {
  ...
  <section className="hero__section pt-[60px] 2xl:h-[800px]">
    <div className="container">
      <div className="flex flex-col lg:flex-row gap-[90px] iterms-center justify-between">
        {/* hero content */}
        <div>
          <div className="lg:w-[570px]">
            ...
            Esse ea, praesentium laborum voluptate dicta aut dolor ducimus aperiam, mollitia soluta sunt quasi dolores? Sunt labore quo ratione sed, 
